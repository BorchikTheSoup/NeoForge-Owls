...
public class ElfOwlEntity extends Animal implements FlyingAnimal {
    public ElfOwlEntity(EntityType<? extends Animal> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new ElfOwlEntity.OwlWanderGoal(this, 3.0));
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return ModEntities.ELF_OWL.get().create(level());
    ...
    public void setupanimationstates(){
        ...
        if (isFlying()) {
            if (this.flyingAnimationTimeout <= 0) {
                this.flyingAnimationTimeout = 10;
